...
def i(attn,df_latest_history):
    # 用这组号码，与过去100次中出的号码进行对比，如果有雷同数量为1的介于43和60之间，且有雷同数量为3的介于2和8之间，则标i 为TRUE
    semblance_list = []
...
def test1():
    ...
    attn = [3,6,9,15,22,31]
    # attn = [7,10,12,16,19,31]
    # attn = [5,19,24,28,30,32]
    # attn = [2,5,16,17,18,30]
    # attn = [2,12,21,23,25,31]
    semblance_with_history(attn,3114,conn)
